...
import com.iiplabs.as2.shared.ISessionObject;

@Configuration
@EnableWebMvc
@ComponentScan(basePackages={"com.iiplabs.as2.web"})
public class SpringConfigurationWebMvc extends WebMvcConfigurerAdapter {
	...
	public void addResourceHandlers(ResourceHandlerRegistry registry) {
	    ...
	    registry.addResourceHandler("/typings/**").addResourceLocations("classpath:/typings/");
	    registry.setOrder(-1);
	}
